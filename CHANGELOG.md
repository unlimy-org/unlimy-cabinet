...
## [1.43.0](https://github.com/unlimy-org/unlimy-cabinet/compare/v1.42.0...v1.43.0) (2026-03-26)


### Features

* account linking and merge UI for cabinet ([93f97d4](https://github.com/unlimy-org/unlimy-cabinet/commit/93f97d45bec4ac4ac893475edd3e79107fe5806b))
* account merge flow — merge redirect, error handling, server-complete linking ([2fc0759](https://github.com/unlimy-org/unlimy-cabinet/commit/2fc0759f89da90b7a349deb8a502417a4f790827))
* adapt dashboard and subscription page for light theme ([f474067](https://github.com/unlimy-org/unlimy-cabinet/commit/f474067efbb36974b47b51ba568304b6cd6b3805))
* add 'no color' option for button style customization ([e586129](https://github.com/unlimy-org/unlimy-cabinet/commit/e586129c37d9152122899d3fea8034ceb03b3993))
* add admin pinned messages section ([88cc0d9](https://github.com/unlimy-org/unlimy-cabinet/commit/88cc0d933e1ee24c854f7e2f32698698201ec06e))
* add admin pinned messages section ([aa5113b](https://github.com/unlimy-org/unlimy-cabinet/commit/aa5113b8e309babb530e849fac12ae87a4769e9f))
* add admin sales statistics dashboard with 5 analytics tabs ([a47c222](https://github.com/unlimy-org/unlimy-cabinet/commit/a47c222310aea2f55bfa6b4df179aa8e27a5293d))
* add animated gradient border to Connect Device buttons ([70e1ed6](https://github.com/unlimy-org/unlimy-cabinet/commit/70e1ed60bd545535b3148aae2b6546f7c17f9552))
* add button reordering within rows and replace modal with inline add panel ([082471b](https://github.com/unlimy-org/unlimy-cabinet/commit/082471bf92cab2577fec6ae047e0ab1ded224ba3))
* add ButtonsTab for per-section button style customization ([b289873](https://github.com/unlimy-org/unlimy-cabinet/commit/b2898730b98b3bf73d075158a9f59ef5bf1f6e54))
* add category/tag management UI with ColoredItemCombobox ([2ae01c9](https://github.com/unlimy-org/unlimy-cabinet/commit/2ae01c95aececf97ddec12337c7251ce6c0a82ec))
* add channel edit in admin, hide subscribed channels in blocking screen ([5a55892](https://github.com/unlimy-org/unlimy-cabinet/commit/5a5589214529e42fd08a3b41929cddd974d52420))
* add configurable animated background for landing pages ([a404690](https://github.com/unlimy-org/unlimy-cabinet/commit/a4046903344855d849482b585fee1e27d13efcae))
* add daily deposits by payment method chart ([f012710](https://github.com/unlimy-org/unlimy-cabinet/commit/f012710df0c19c00de0c71c51515e03373a29eb5))
* add daily traffic & device purchase chart to addons stats ([2235b3c](https://github.com/unlimy-org/unlimy-cabinet/commit/2235b3cb77eb266b86eb98175e52855c6a08c828))
* add dashboard sub-components for subscription cards and stats grid ([909374d](https://github.com/unlimy-org/unlimy-cabinet/commit/909374d369589474623ee006779586fadddd485b))
* add dedicated TopUpResult page for payment return flow ([b591228](https://github.com/unlimy-org/unlimy-cabinet/commit/b59122818c3242ffab512b896f75179dd9a13c1b))
* add delete buttons for categories and tags in combobox dropdown ([be7219e](https://github.com/unlimy-org/unlimy-cabinet/commit/be7219ec06efdfff6052cbcf6bd736af2e3691fc))
* add discount UI for landing pages ([f7afa00](https://github.com/unlimy-org/unlimy-cabinet/commit/f7afa002f08cfde0421ab8cfed8f699608fd6bc9))
* add external squad selection to tariff admin form ([bc45294](https://github.com/unlimy-org/unlimy-cabinet/commit/bc452944876b64c5346dc04d53c561831fb31bd8))
* add fill+border dual-color nodes, radial layout, and dark labels ([b18f3fb](https://github.com/unlimy-org/unlimy-cabinet/commit/b18f3fb211112c3a72db49a4b682e29257dd28ae))
* add fonts, animations, and shared utilities for dashboard redesign ([7e345fc](https://github.com/unlimy-org/unlimy-cabinet/commit/7e345fc7d0431415496f8363959773e99a853b6e))
* add Freekassa SBP and card payment method icons and labels ([a725265](https://github.com/unlimy-org/unlimy-cabinet/commit/a72526502605ab415c16d3506c6fd4aa0bee5c95))
* add fullscreen QR code for subscription connection ([4d14e3e](https://github.com/unlimy-org/unlimy-cabinet/commit/4d14e3e8062c321e56fc37e79ed6cc16fa83df2a))
* add gift navigation, routes, and i18n translations ([7890d48](https://github.com/unlimy-org/unlimy-cabinet/commit/7890d480e05e87f77ea2fea3ae3a7e955bd167d3))
* add gift purchase UI states for telegram recipients ([eed077b](https://github.com/unlimy-org/unlimy-cabinet/commit/eed077b0197f215c8f74f70a2bf0b73fd41d4628))
* add gift subscription API client and feature flag ([a495205](https://github.com/unlimy-org/unlimy-cabinet/commit/a49520566e46eb0cfdc22a3661c5ba405dc6cc92))
* add gift subscription toggle to admin branding settings ([9542607](https://github.com/unlimy-org/unlimy-cabinet/commit/9542607832561a8a72bb742947f3388bdaa087dc))
* add gifts tab to admin user detail page ([695ab42](https://github.com/unlimy-org/unlimy-cabinet/commit/695ab42e03a0a77ecdbede1f8621dca6baf4b374))
* add GiftSubscription and GiftResult pages ([814b1f5](https://github.com/unlimy-org/unlimy-cabinet/commit/814b1f5e96f968d9bc2829ba395ac187fa4d2e11))
* add gradient fade indicators to scrollable desktop nav ([622172f](https://github.com/unlimy-org/unlimy-cabinet/commit/622172f0387dc7f029c8af797d1f8df2e790771e))
* add granular user permissions (balance, subscription, promo_group, referral, send_offer) ([3d6987f](https://github.com/unlimy-org/unlimy-cabinet/commit/3d6987f761b168113c009845d8ff028f9ca86688))
* add HoverBorderGradient effect to key action buttons ([3fb9606](https://github.com/unlimy-org/unlimy-cabinet/commit/3fb9606fd0f5bf765e117436e7507b4c7c226e89))
* add i18n translations and admin category for Telegram OIDC ([c221c6e](https://github.com/unlimy-org/unlimy-cabinet/commit/c221c6e8bfc15b160565083f0198816d4c84c146))
* add landing page statistics page with recharts ([3019019](https://github.com/unlimy-org/unlimy-cabinet/commit/30190199ed88cde6aea575eed44a2f7d4361dbdc))
* add landings permission section translations for role editor ([5228b2d](https://github.com/unlimy-org/unlimy-cabinet/commit/5228b2dea6f1adc78c521c197d09726a286516ba))
* add LIMITED subscription status support with traffic-exhausted UX ([b4f9f33](https://github.com/unlimy-org/unlimy-cabinet/commit/b4f9f332cf714717ed52cd18a82af9d2feb22416))
* add media attachment support for admin ticket replies ([84f0e4e](https://github.com/unlimy-org/unlimy-cabinet/commit/84f0e4e9b4fd6b73444505696d3dd20a30cc0c82))
* add media upload to news editor with drag-drop, paste, and file picker ([723591e](https://github.com/unlimy-org/unlimy-cabinet/commit/723591e5c386639f69a3716a306e04906224df24))
* add menu editor tab with drag-and-drop rows, custom URL buttons, and button configuration ([23aa86f](https://github.com/unlimy-org/unlimy-cabinet/commit/23aa86f1a81556ce2083e8b86107ee1a82c429b1))
* add multi-channel subscription blocking UI and admin management ([a767fe9](https://github.com/unlimy-org/unlimy-cabinet/commit/a767fe96d3992f91b5c1b722de132ea67f975432))
* add news section with admin editor and public article view ([99fc336](https://github.com/unlimy-org/unlimy-cabinet/commit/99fc33625e95430d465f09229b4f56a22a0589c1))
* add open_in setting for custom buttons (external browser / Telegram miniapp) ([638844e](https://github.com/unlimy-org/unlimy-cabinet/commit/638844ef47686f4c9540b5591d499255cdc8ff2f))
* add partner → campaign edges with distinct color to referral network ([2adb004](https://github.com/unlimy-org/unlimy-cabinet/commit/2adb0047dda970df58ccddbcc00193441680c7e8))
* add partner management and withdrawal admin pages ([779fbf0](https://github.com/unlimy-org/unlimy-cabinet/commit/779fbf0dc61b5963e2ac48162b02a292155457a5))
* add payment sub-option selection on quick purchase page ([58e93cd](https://github.com/unlimy-org/unlimy-cabinet/commit/58e93cd2b72979ec95dd43ba7d6670d879e2f07d))
* add per-button enable/disable toggle and custom labels per locale ([1a0a5ff](https://github.com/unlimy-org/unlimy-cabinet/commit/1a0a5ff45313da383ed402b09a630e2774d2ae04))
* add per-channel disable settings and global settings to channel admin ([48be067](https://github.com/unlimy-org/unlimy-cabinet/commit/48be067d1b41f57b02d97405b8a92538c306dabd))
* add purchases list with pagination to landing stats page ([887b13d](https://github.com/unlimy-org/unlimy-cabinet/commit/887b13dec22bbb6c4f07e8035cbbeefc437f10e2))
* add QR code and command to deeplink auth fallback, fix polling on tab return ([76c9d64](https://github.com/unlimy-org/unlimy-cabinet/commit/76c9d6448aa2cf79a856076a781c3f285633ee10))
* add RBAC permission system to admin cabinet frontend ([874ee26](https://github.com/unlimy-org/unlimy-cabinet/commit/874ee2682e50d9deca42b794a4be0ae0dd95ab5c))
* add recharts analytics to admin campaign stats page ([c7d05c4](https://github.com/unlimy-org/unlimy-cabinet/commit/c7d05c4809166341a1702566a343946fe9126797))
* add referral code persistence across all auth methods ([2b2ead8](https://github.com/unlimy-org/unlimy-cabinet/commit/2b2ead837c457a02c8a153d6b25cae492aa5e617))
* add referral network graph visualization page ([235eaec](https://github.com/unlimy-org/unlimy-cabinet/commit/235eaec85f46e46b4b588f325811a448a02dbcc3))
* add reset traffic toggle on tariff switch ([49fff8e](https://github.com/unlimy-org/unlimy-cabinet/commit/49fff8e85520ef3ee08cb06c473ba875cdf05dc6))
* add sales_stats RBAC permission section to frontend ([262303d](https://github.com/unlimy-org/unlimy-cabinet/commit/262303d623a6e8a597b3aa9310d1b8290b494595))
* add show_in_gift toggle UI for tariffs in admin panel ([5a5a987](https://github.com/unlimy-org/unlimy-cabinet/commit/5a5a9878931234103761d40fb24893afdb16a817))
* add sub-options UI for landing payment methods + extract components ([d0be127](https://github.com/unlimy-org/unlimy-cabinet/commit/d0be127d30574af1cb90503943bfa721dda8e645))
* add Telegram account linking UI with CSRF protection ([a6fabb1](https://github.com/unlimy-org/unlimy-cabinet/commit/a6fabb1d9d79c6a233e1ac52fcd006d9dea31a3e))
* add TrafficProgressBar and Sparkline components ([eb1f788](https://github.com/unlimy-org/unlimy-cabinet/commit/eb1f788033c696c1077002048f144b0bfd59592b))
* add translations for permission sections and actions ([80bfaca](https://github.com/unlimy-org/unlimy-cabinet/commit/80bfaca457192d25af182365da8c18a8f97c7830))
* add user filter chips and resource types to audit log ([4072274](https://github.com/unlimy-org/unlimy-cabinet/commit/40722747e33c2dcc5d5ccc1d213b4d2eb39e0f26))
* add web campaign links — capture, auth integration, bonus UI ([e0dd21f](https://github.com/unlimy-org/unlimy-cabinet/commit/e0dd21fd0bde52c4b10175635e605151eb8faf9d))
* add weekdays condition to ABAC policies ([a1a8dc2](https://github.com/unlimy-org/unlimy-cabinet/commit/a1a8dc22034def5802791e1ceda4da6a3558db6b))
* admin partner settings page, partner section visibility toggle, custom requisites text ([76d20fd](https://github.com/unlimy-org/unlimy-cabinet/commit/76d20fdb1aa374b2de3f075bda4672484b8b8de6))
* allow editing system roles ([a050125](https://github.com/unlimy-org/unlimy-cabinet/commit/a050125ea8d4265f096bafe0317e811289f38738))
* clickable user link to user card in admin payments ([aa8fbd1](https://github.com/unlimy-org/unlimy-cabinet/commit/aa8fbd1e23c9ee503b871d0de945eee5d4af4d2c))
* color-code referral network nodes by subscription status ([b289ea9](https://github.com/unlimy-org/unlimy-cabinet/commit/b289ea9c2315d4cb15aeb76da04cc0220fd16cbe))
* compact login page with collapsible email, icon OAuth row, safe areas ([45cbfb5](https://github.com/unlimy-org/unlimy-cabinet/commit/45cbfb5ecb194eb9cdcee5a9cf8b4f79c20c1444))
* custom broadcast buttons UI and fix stale mediaType bug ([86d997d](https://github.com/unlimy-org/unlimy-cabinet/commit/86d997d01d860b42a4d7fd61c703dc03c39f0a2a))
* deep link авторизация при блокировке oauth.telegram.org ([6a1a9f5](https://github.com/unlimy-org/unlimy-cabinet/commit/6a1a9f5db7c3a2aa553e8965c1d6e7d65a40dc6e))
* **deploy:** deploy.yml update ([bc8ca96](https://github.com/unlimy-org/unlimy-cabinet/commit/bc8ca96c248e436c76d332b0cd541e4ee3629694))
* desktop nav expand-on-hover with larger icons ([8dab6dc](https://github.com/unlimy-org/unlimy-cabinet/commit/8dab6dc8fb8ef7ba97c94fa71cff5b4ed750198d))
* display manual admin top-ups in sales statistics ([a3a6fad](https://github.com/unlimy-org/unlimy-cabinet/commit/a3a6fad9b76f9908b8240a05629d9d7eac1af98f))
* display per-campaign stats on partner detail page ([75a6149](https://github.com/unlimy-org/unlimy-cabinet/commit/75a6149e2db4fd0ead705c431ff04ea6d9ffc3d2))
* display promo group and active discount banners on gift page ([03c9e73](https://github.com/unlimy-org/unlimy-cabinet/commit/03c9e73a372f0357757a1835a933bedceaa7749a))
* display user promo group badge on dashboard ([c579abe](https://github.com/unlimy-org/unlimy-cabinet/commit/c579abe6a35cf86a7e001567eb1328b768b71772))
* dual referral links UI (bot + cabinet) with independent copy states ([e023373](https://github.com/unlimy-org/unlimy-cabinet/commit/e023373f56a06afc2b95b32930986bd1cdd4d241))
* enhance sales stats with device stats, per-tariff charts, and dual-series trials ([4622b4b](https://github.com/unlimy-org/unlimy-cabinet/commit/4622b4b200bb2973115b0a9891b0ec5956af89d2))
* gift subscription redesign — code-only purchase + 3-tab UI ([af3e535](https://github.com/unlimy-org/unlimy-cabinet/commit/af3e535c698e7046f420b80a781991505f0c0ffb))
* guest purchase activation UI & landing editor improvements ([b852e1e](https://github.com/unlimy-org/unlimy-cabinet/commit/b852e1e4cda7303e19ac7af8c3826e2ba52ac68a))
* guest purchase cabinet credentials UI ([d228d99](https://github.com/unlimy-org/unlimy-cabinet/commit/d228d997d8360f8a15a23ec007a06048af7bd47d))
* improve audit log - translate actions, fix resource filter, show request body ([5d0e353](https://github.com/unlimy-org/unlimy-cabinet/commit/5d0e3539e22576e1824292da09c396123349b371))
* migrate Telegram Login Widget to v23 with admin-configurable settings ([2c65ca8](https://github.com/unlimy-org/unlimy-cabinet/commit/2c65ca8a7ff372725bcbaa002e96bd043022bad1))
* multi-select scope for referral network graph ([db76cd0](https://github.com/unlimy-org/unlimy-cabinet/commit/db76cd0c647fb7be986bdebad4cf7f56b554334c))
* open OAuth linking in external browser from Telegram Mini App ([7c30a1e](https://github.com/unlimy-org/unlimy-cabinet/commit/7c30a1eab616846253df1ec2c93b97259a54c8b8))
* partner-campaign integration in admin UI ([959f892](https://github.com/unlimy-org/unlimy-cabinet/commit/959f89266bd7fe6e8a38d218c7d34e14c509a21b))
* read gift warning from status response, soften poll error state ([4322d58](https://github.com/unlimy-org/unlimy-cabinet/commit/4322d58ff8ca56ba401b669370bee8783cf55a86))
* redesign referral network with scope selector ([a6faf70](https://github.com/unlimy-org/unlimy-cabinet/commit/a6faf702ec445f899ab0a9b93d668340483c44de))
* replace animated backgrounds with Aceternity UI system ([1a702a6](https://github.com/unlimy-org/unlimy-cabinet/commit/1a702a68b9cad0f112a65494250c11758388a91f))
* responsive desktop nav — icon-only on lg, icon+text on xl ([e7cd370](https://github.com/unlimy-org/unlimy-cabinet/commit/e7cd3702997144725ac90289e5aecd101856bc92))
* show affected subscriptions count on tariff deletion ([f10a02c](https://github.com/unlimy-org/unlimy-cabinet/commit/f10a02ceb6649b2dd4301365919fc066d604e95f))
* show blocked_count in broadcast admin UI ([9cf8e09](https://github.com/unlimy-org/unlimy-cabinet/commit/9cf8e095b8ce45ea92f6289bf275cd82e264dcde))
* show localized error for self-activation attempt ([7549ae7](https://github.com/unlimy-org/unlimy-cabinet/commit/7549ae70eb3ae14ae0cd4a45e5033675f4555c6a))
* show partner campaign links with bonuses on referral page ([8b33d82](https://github.com/unlimy-org/unlimy-cabinet/commit/8b33d8224d63509408f96919d702d1eb21bc050a))
* show query params in audit log details ([66f7fcb](https://github.com/unlimy-org/unlimy-cabinet/commit/66f7fcb3dca32748503f1ab92155818369f94da6))
* show short device identifier (HWID) in device list ([58b1f96](https://github.com/unlimy-org/unlimy-cabinet/commit/58b1f96852fb32f57bfb1ca255b27ebc021236e9))
* show subscription revenue and referral earnings in network stats ([5b12784](https://github.com/unlimy-org/unlimy-cabinet/commit/5b12784ab84b6b3afed015b3172d34c6015b9e33))
* show traffic reset info in subscription card ([271a005](https://github.com/unlimy-org/unlimy-cabinet/commit/271a005e87d21f6a82aad7272c92775a6e1aec6c))
* show traffic reset period on tariff cards ([cfe9f64](https://github.com/unlimy-org/unlimy-cabinet/commit/cfe9f642d842fc0696e379ef59934b300c363a24))
* split my gifts into Active/Activated/Received sections ([51ec799](https://github.com/unlimy-org/unlimy-cabinet/commit/51ec799c0c47189f9388dd6b19ca3329a55cf653))
* support disabled daily subscription status in cabinet UI ([7940410](https://github.com/unlimy-org/unlimy-cabinet/commit/7940410d7d913e8c92a7732f4fdc4ababd06ba3b))
* TelegramLoginButton with OIDC popup + legacy widget fallback ([91f0e9e](https://github.com/unlimy-org/unlimy-cabinet/commit/91f0e9e2fcd0d9c3f3dc7f7e31b763244350f754))
* unified device manager with dot-based selector ([edb7ef0](https://github.com/unlimy-org/unlimy-cabinet/commit/edb7ef0488b0ae994b7a37be9b95d1ab007feb09))
* блокировка кнопки устройств при лимите + убраны дубли трафика ([8636bd7](https://github.com/unlimy-org/unlimy-cabinet/commit/8636bd7659b6b18cc9e19bce5bf5c6637da21d72))
* добавлена поддержка SeverPay в кабинете ([246fafd](https://github.com/unlimy-org/unlimy-cabinet/commit/246fafdbfc1db6384d1626ae09e04431c72f61e2))
* кликабельные имена пользователей в последних платежах ([e278fec](https://github.com/unlimy-org/unlimy-cabinet/commit/e278fec506e17281d0fb92cb04348b269dc8e30e))
* мультиязычные лендинги + переключатель языка + исправления по ревью ([ab13616](https://github.com/unlimy-org/unlimy-cabinet/commit/ab13616b0f0d31eac007a4c4b7f4f360f0f3c9b4))
* публичные лендинг-страницы для быстрой покупки VPN-подписок ([8b5d777](https://github.com/unlimy-org/unlimy-cabinet/commit/8b5d777f0a94296330227b5fab34c65c83fb3baa))
* редизайн страницы платежей в админке — поиск, фильтры, статистика ([df73b3f](https://github.com/unlimy-org/unlimy-cabinet/commit/df73b3f77e4fe38715ca74782120f4c52ad0b1b7))


### Bug Fixes

* accessibility, query cache clear, post-merge navigation ([e447e99](https://github.com/unlimy-org/unlimy-cabinet/commit/e447e993cb10989f55525d9bb57ed8a5d5ad9d97))
* activation broken — token uppercased + wrong env var for bot username ([d852bfe](https://github.com/unlimy-org/unlimy-cabinet/commit/d852bfe969ed140f53872c5bdd8104ac20aecd34))
* adapt admin landings list for mobile layout ([b7c7dec](https://github.com/unlimy-org/unlimy-cabinet/commit/b7c7decfd0f2818b65861699336d6221ba0e0ae2))
* adapt referral network for Telegram MiniApp safe areas ([33486a0](https://github.com/unlimy-org/unlimy-cabinet/commit/33486a09d01b19961e02d4d72b63710e7cf8bc8f))
* add fill border to node-border program config ([5a92484](https://github.com/unlimy-org/unlimy-cabinet/commit/5a92484912e1b6f251f1c1c13a68f5c6eeaa2d2a))
* add max attribute to expected referrals input ([d1043e8](https://github.com/unlimy-org/unlimy-cabinet/commit/d1043e83eaa163079a0272860b2d6a8f68332cf6))
* add missing cancelled filter key to withdrawal i18n in all locales ([9b2742f](https://github.com/unlimy-org/unlimy-cabinet/commit/9b2742ff3afc627bfe382859e9239b5ba9104ea4))
* add missing nameRequired i18n key for promo group form validation ([78fda22](https://github.com/unlimy-org/unlimy-cabinet/commit/78fda22679b9f5b4443fa602214e28ad52f7f2e9))
* add missing onError handlers on RBAC mutations ([c4e3211](https://github.com/unlimy-org/unlimy-cabinet/commit/c4e3211baa3bfec81cc0efec4467660180e42ba7))
* add multipart/form-data header to news media upload request ([4bcae6c](https://github.com/unlimy-org/unlimy-cabinet/commit/4bcae6ce11e18c42f8dd99316b918bfb70cb8fc5))
* add news link to admin panel, prevent empty news section flash ([38b0f4b](https://github.com/unlimy-org/unlimy-cabinet/commit/38b0f4be9a921fa1af4a49817f6b17d738c5b074))
* add null guard for purchase_token before rendering CodeOnlySuccessState ([51cc122](https://github.com/unlimy-org/unlimy-cabinet/commit/51cc1221d0129018828b2abf0f273caada599649))
* add pagination to campaigns list ([46f640a](https://github.com/unlimy-org/unlimy-cabinet/commit/46f640a7e0c2026c7629f0cd4cd01f7f4758bbe5))
* add purchase-options cache invalidation on balance changes ([f1102d2](https://github.com/unlimy-org/unlimy-cabinet/commit/f1102d278354ae3225f8b36029590d8c01b74ea0))
* add Referrer-Policy to prevent merge token leakage via Referer header ([584f002](https://github.com/unlimy-org/unlimy-cabinet/commit/584f00297bfc38fefc372f28ba0947300b8a6064))
* add resend email cooldown and allow email change for all auth types ([91d567f](https://github.com/unlimy-org/unlimy-cabinet/commit/91d567f9cc48dea7d605b55c6014174806b8d9ab))
* add subscription tab to desktop nav, fix device dots overflow, show available referral balance ([27f85a1](https://github.com/unlimy-org/unlimy-cabinet/commit/27f85a1db115ca386c5658786147800e33f484bc))
* add tooltip text color for dark theme in all charts ([d640cc1](https://github.com/unlimy-org/unlimy-cabinet/commit/d640cc1a04825b687d59b3a7b2d7fa814e189819))
* add tooltip text color for dark theme in landing stats charts ([18b8605](https://github.com/unlimy-org/unlimy-cabinet/commit/18b860533cfb6d6e27ebdad919fc86b7406309b5))
* add unmount safety guard to OIDC callback handler ([dfa7a09](https://github.com/unlimy-org/unlimy-cabinet/commit/dfa7a09a7cb53ebbbc5de057fd587897d77dcb9b))
* address code review findings for TelegramLoginButton ([5c11f12](https://github.com/unlimy-org/unlimy-cabinet/commit/5c11f1251a9bdbb60f49c105b1a3ebcbd477d8b8))
* admin landing editor — tariff period mapping and cleanup ([6a92814](https://github.com/unlimy-org/unlimy-cabinet/commit/6a92814ce25bb718ce29450adbd7d01775e4e1dc))
* admin promo groups - add default toggle, fix threshold reset to 0 ([9c7ab4b](https://github.com/unlimy-org/unlimy-cabinet/commit/9c7ab4b789f0d2e92c81afd2199789d03d3768db))
* align RecentPaymentItem types with backend schema ([3f05039](https://github.com/unlimy-org/unlimy-cabinet/commit/3f050396b8d784d1f5d32a949cfab2caaef4ddac))
* align TypeScript types with backend referral schemas ([11343f4](https://github.com/unlimy-org/unlimy-cabinet/commit/11343f4f12e0f082225f7413308972cb8ed92717))
* allow animated background to show through on landing pages ([66bb86a](https://github.com/unlimy-org/unlimy-cabinet/commit/66bb86a5f286b40eb0cc7cbac8a82ad3d6336de2))
* allow email change for unverified emails without code verification ([a0b10e6](https://github.com/unlimy-org/unlimy-cabinet/commit/a0b10e688cd96ecbab767bed4ee1abdd5aefc4db))
* animation config not updating for users after admin change ([94ddf31](https://github.com/unlimy-org/unlimy-cabinet/commit/94ddf319bd242211cbebf74e89a6052856f84f60))
* auto-select single sub-option and remove unused return_url field ([83fbd0e](https://github.com/unlimy-org/unlimy-cabinet/commit/83fbd0e44564a3b5f174f52549ff29b638701067))
* bar chart white hover cursor on dark theme ([14e5f43](https://github.com/unlimy-org/unlimy-cabinet/commit/14e5f436ce8e1ad110e60169095631916bf167d3))
* block wheel spin without active subscription ([821e991](https://github.com/unlimy-org/unlimy-cabinet/commit/821e991f51db6033d3e0f2befecf15c364d0e3e8))
* bottom nav overlap and safe area handling in referral network ([94c8e73](https://github.com/unlimy-org/unlimy-cabinet/commit/94c8e73787ac40b73808785a5e12074bd1840bd9))
* boxes background not covering full screen ([f16f96e](https://github.com/unlimy-org/unlimy-cabinet/commit/f16f96e442506484eae9434ae51c5f0f2fc45729))
* boxes background not covering viewport ([65afb29](https://github.com/unlimy-org/unlimy-cabinet/commit/65afb292747b0e57865bc4c0d5df320fbc58b261))
* check apps before subscription on connection page ([a4e6e35](https://github.com/unlimy-org/unlimy-cabinet/commit/a4e6e35da1f86163fbdb0ba90fd28c8ccdef4ed6))
* clean up expired trial card - remove redundant badge and subtitle ([d2f02d6](https://github.com/unlimy-org/unlimy-cabinet/commit/d2f02d605c5990bc88fbade5f6fa6e7624abd70b))
* clear all cached auth state on Telegram MiniApp retry ([3e27472](https://github.com/unlimy-org/unlimy-cabinet/commit/3e27472c8aaf836e855a7163f5a2829395655ccc))
* clear expire timer on 410/error and reset pollInFlight on retry ([1538879](https://github.com/unlimy-org/unlimy-cabinet/commit/1538879f970bcadc115d10ff027ce4d015606099))
* CopiedToast not visible due to CSS transform context ([39bdf8b](https://github.com/unlimy-org/unlimy-cabinet/commit/39bdf8b5c3e79e2c224db29f3c87d17135e2e0fb))
* correct locale loader type to support nested translation objects ([ab03947](https://github.com/unlimy-org/unlimy-cabinet/commit/ab0394776ad5f23778f45618e283fb319e4c688c))
* correct locale loader type to support nested translation objects ([682b6b7](https://github.com/unlimy-org/unlimy-cabinet/commit/682b6b70dc65e14e8dc6c68c59501d5ca1a2171a))
* correct memory display to use actual usage instead of cache-inclusive ([67bacd3](https://github.com/unlimy-org/unlimy-cabinet/commit/67bacd3e7a36fa70c4ee97008849f0251600a7b8))
* cover all payment provider statuses in TopUpResult ([8897561](https://github.com/unlimy-org/unlimy-cabinet/commit/8897561fb2af322b4b37b84ac07b7746fde70586))
* daily tariff renewal uses purchaseTariff instead of renewSubscription ([8629cfe](https://github.com/unlimy-org/unlimy-cabinet/commit/8629cfea18aab9daf818f1f6c8e250ede29054d4))
* deep link auth timer cleanup and reliability ([3d95025](https://github.com/unlimy-org/unlimy-cabinet/commit/3d950252b70b59a6a0f49976aeb87686e850d0e9))
* defer Sigma init with requestAnimationFrame to prevent no-height crash ([6f58a0c](https://github.com/unlimy-org/unlimy-cabinet/commit/6f58a0ce5d326eb67a154b6f2687873aac6cd247))
* desktop nav always icon-only with tooltips ([f0777f0](https://github.com/unlimy-org/unlimy-cabinet/commit/f0777f0b5db9115b84bdcb37eb9dab6650bd725b))
* detect Telegram account switch across tab closes ([ee6ec59](https://github.com/unlimy-org/unlimy-cabinet/commit/ee6ec5959c2e25deecfdbf93b79c04cb150dc7f2))
* device purchase guard condition and cache invalidation ([115c684](https://github.com/unlimy-org/unlimy-cabinet/commit/115c684fe00d0e209953e4bdd3ff5d213909e423))
* disable duplicate link/underline extensions from StarterKit ([59d8b66](https://github.com/unlimy-org/unlimy-cabinet/commit/59d8b66884e544f2752e843c6040adfaa3b78cc4))
* display zero-amount transactions with neutral styling ([6fd76c8](https://github.com/unlimy-org/unlimy-cabinet/commit/6fd76c8dc89c5fb4d766a94a47048dde0f0afc83))
* double-click guard on link, wall-clock timer, blur cleanup ([8ad0500](https://github.com/unlimy-org/unlimy-cabinet/commit/8ad0500cc80fee51b03880e7988ffe1192e7f214))
* eliminate hover flickering across all pages ([bdc201b](https://github.com/unlimy-org/unlimy-cabinet/commit/bdc201b5ea5e359a7f9d97bd86202be35654a7fe))
* fallback to referral role fill color when subscription_status is null ([61ca5cc](https://github.com/unlimy-org/unlimy-cabinet/commit/61ca5cc53dfe1a1cf064461007c81a496bc9c234))
* force fresh balance data on purchase-options query ([69a8fe8](https://github.com/unlimy-org/unlimy-cabinet/commit/69a8fe8e03aca6b0a984a0acb3ed5d9091ed4737))
* fullscreen layout and filter dropdown positioning ([4ebd85b](https://github.com/unlimy-org/unlimy-cabinet/commit/4ebd85b65d7bb2ebdace8eae3efc8b6fd4ef61cc))
* gift code display + share modal backdrop ([a627eb0](https://github.com/unlimy-org/unlimy-cabinet/commit/a627eb0b30a6f65a8a0f40c13a891b4beb8e2e79))
* gift UI improvements — declension, GB display, share modal, deep links ([1bafcca](https://github.com/unlimy-org/unlimy-cabinet/commit/1bafcca1ef58d98f044575511bbccf2c17825aa2))
* graph layout, node visibility and FA2 settings ([7c0b8e5](https://github.com/unlimy-org/unlimy-cabinet/commit/7c0b8e571a613173ed9cec6e87af469c6b141ca8))
* guard oauthProviders with Array.isArray to prevent TypeError on Login page ([f74e316](https://github.com/unlimy-org/unlimy-cabinet/commit/f74e316161c3bea18bc9493e683556314db6172b))
* guard user detail API calls with RBAC permission checks ([bc5d832](https://github.com/unlimy-org/unlimy-cabinet/commit/bc5d832e0d3faf5dc6f64a6359e32d75e68c4282))
* handle long promo group names with truncation and flex-wrap ([4a33a61](https://github.com/unlimy-org/unlimy-cabinet/commit/4a33a61641ac6bf325988a5d60a2d07cd15c2a71))
* handle Pydantic validation errors in notify + nullify empty optional fields ([9bd58cb](https://github.com/unlimy-org/unlimy-cabinet/commit/9bd58cb914623b75ec2a035e8c6e077b0fe45e8d))
* handle Telegram Stars payment for gift subscriptions via openInvoice ([01e811b](https://github.com/unlimy-org/unlimy-cabinet/commit/01e811bdfc5db4e0680c1b7d4bed5e91a66e503c))
* handle unlimited traffic package selection and button text ([1d6ec70](https://github.com/unlimy-org/unlimy-cabinet/commit/1d6ec70116a2d2f776a088e5045e72cfc5d452ae))
* harden gift subscription frontend after multi-agent review ([6ea1de2](https://github.com/unlimy-org/unlimy-cabinet/commit/6ea1de2e8afba93361c48a364ddc5406f6bc5d4b))
* harden merge UI and improve error handling ([58cf1e3](https://github.com/unlimy-org/unlimy-cabinet/commit/58cf1e3b504c8577e6d6aa081bf861cb871fb765))
* harden OAuth login flow — open redirect, path traversal, info leak ([a744b41](https://github.com/unlimy-org/unlimy-cabinet/commit/a744b41910743e9604de669535f56a614fa269f1))
* hide empty blocks in connection installation guide ([96f9a71](https://github.com/unlimy-org/unlimy-cabinet/commit/96f9a719fd02d5f21c2bd3753c4eb8afd36887c6))
* hide Quick Renew for expired trial subscriptions ([8b056e0](https://github.com/unlimy-org/unlimy-cabinet/commit/8b056e0b463d05106d389c41eae671684df7b043))
* hide trial banner when subscription expired banner is active ([d34f5e8](https://github.com/unlimy-org/unlimy-cabinet/commit/d34f5e85596e7f34804a4e78dcef06e61bd62cd9))
* improve campaign stats, shared chart components, and i18n coverage ([673de08](https://github.com/unlimy-org/unlimy-cabinet/commit/673de08dd4ad95a55fd70e230022a920fa8ea279))
* improve graph spacing, mobile layout, and Telegram viewport ([818557f](https://github.com/unlimy-org/unlimy-cabinet/commit/818557f57d486a47c2965d4f3dfc0eb385ead7ad))
* improve HoverBorderGradient visibility with accent colors and darker bg ([4332c2b](https://github.com/unlimy-org/unlimy-cabinet/commit/4332c2bd253774ddaef87f5735eec15f2b9645ee))
* improve light theme visibility for dashboard and subscription cards ([4cdff97](https://github.com/unlimy-org/unlimy-cabinet/commit/4cdff9730b3c70d88c1b32f00561b16673a2d55a))
* improve light theme visibility for inner panels on subscription page ([430b703](https://github.com/unlimy-org/unlimy-cabinet/commit/430b703bbea7c923a54824b3a814d59f61065831))
* infinite reload loop on login when Telegram widget unavailable ([c34375e](https://github.com/unlimy-org/unlimy-cabinet/commit/c34375e579b159b9a47421c4fddd992d630e74aa))
* isolate content layer from animated background to eliminate flickering ([04eacf6](https://github.com/unlimy-org/unlimy-cabinet/commit/04eacf642184867f5ab3437f0aef09ff4ee73e0c))
* isolated DOMPurify instance and correct video controls attribute ([f788f10](https://github.com/unlimy-org/unlimy-cabinet/commit/f788f1034ccfe62dcfedc5eed52086b7f36e5a82))
* landing list crash — title is now LocaleDict, not string ([6755c1d](https://github.com/unlimy-org/unlimy-cabinet/commit/6755c1dc458e7f3ff68fb180306f72b17ff2a5b8))
* load telegram-web-app.js asynchronously to prevent page blocking ([c5f621b](https://github.com/unlimy-org/unlimy-cabinet/commit/c5f621b399e415d58af8c3c9723ec473294138e7))
* make desktop nav horizontally scrollable on narrow screens ([ab7d1b7](https://github.com/unlimy-org/unlimy-cabinet/commit/ab7d1b7f25215aa6fb8fe7978d570f02d884b032))
* make trial, campaign, and no-subscription node colors distinct ([2a57442](https://github.com/unlimy-org/unlimy-cabinet/commit/2a57442e04c1b09690504e5ad9bb96a3fcb9f7c4))
* media upload security hardening from 6-agent review ([7408000](https://github.com/unlimy-org/unlimy-cabinet/commit/74080004e8156ad1f302f9c3b5ad809c6b3b8742))
* **merge:** accessibility, token guard, state cleanup ([579f47e](https://github.com/unlimy-org/unlimy-cabinet/commit/579f47e563a13f4a56ca92064949d594bfe66063))
* mobile layout and period label translations for quick purchase landing ([6d5c6fb](https://github.com/unlimy-org/unlimy-cabinet/commit/6d5c6fb9b3905d8a0c22f39317fd5f77743d3505))
* mobile layout overflow on landing page ([9aae9cc](https://github.com/unlimy-org/unlimy-cabinet/commit/9aae9cc0e6e650ff6eb6633b0d08c952aa7f2c4a))
* move cabinet_branding to sessionStorage and add WebGL availabili… ([8200014](https://github.com/unlimy-org/unlimy-cabinet/commit/820001458bcc22e072d21e2faa9b4fe819b4dbad))
* move cabinet_branding to sessionStorage and add WebGL availability check ([fc7ee6a](https://github.com/unlimy-org/unlimy-cabinet/commit/fc7ee6abfe9920e1b3a51254fde877b66bcfb39a))
* move CTA button above additional options section ([0bc817f](https://github.com/unlimy-org/unlimy-cabinet/commit/0bc817fa7f201e9176a586bb1b5c0a68c9406bf6))
* move useState before useMutation for consistent hook ordering ([fba4481](https://github.com/unlimy-org/unlimy-cabinet/commit/fba4481799081b05f0b082bcf983c6ac4c4daf1b))
* news feature security, accessibility, performance improvements ([74e6d52](https://github.com/unlimy-org/unlimy-cabinet/commit/74e6d52fee474f73f148c3f0081be727aa9b7e64))
* news section — remove duplicate title, add newspaper icon, hide views from users, fix cache invalidation ([b7ab2cf](https://github.com/unlimy-org/unlimy-cabinet/commit/b7ab2cff55a206d7a705ffe42a01a652c5c1ddba))
* normalize all API responses, add error handling and reset confirmation ([150a1b2](https://github.com/unlimy-org/unlimy-cabinet/commit/150a1b2dbaeffbf39e00c6f75b2761a854821b09))
* OIDC login UX improvements from review ([b335d66](https://github.com/unlimy-org/unlimy-cabinet/commit/b335d666c2c1fb557288d70fb249e4166f99b146))
* ordered list numbering in Info page shows correct sequence ([8157ca5](https://github.com/unlimy-org/unlimy-cabinet/commit/8157ca5f0280dbcbf99eda210cd83130ec77c0b1))
* parse raw query string for deep link params to avoid double-decode ([ed65c29](https://github.com/unlimy-org/unlimy-cabinet/commit/ed65c29bacbfc50cdfa11e58f0cb638c6c8c1841))
* partner system bugs - commission field, withdrawal UX, admin amount ([e94d81f](https://github.com/unlimy-org/unlimy-cabinet/commit/e94d81fe5a25341172bb787146fd80d70067a140))
* plug memory leaks in blob URLs and traffic cache ([7cf7273](https://github.com/unlimy-org/unlimy-cabinet/commit/7cf72735ece0510acc7a4e6af8997e8e7acdc9d8))
* position page below AppShell header, wait for container size ([fd9a47e](https://github.com/unlimy-org/unlimy-cabinet/commit/fd9a47ecda6660903bea54b6cf2a838392fd85cd))
* preserve + chars in deep link URL params for crypto links ([65add9a](https://github.com/unlimy-org/unlimy-cabinet/commit/65add9a111086f970c77d686447016551ca9ab0f))
* prevent button settings cards from overflowing in admin panel ([54f1483](https://github.com/unlimy-org/unlimy-cabinet/commit/54f1483312e776f3c02cdcd797fe392482ed3e1d))
* prevent buyer from activating gift pending subscription ([97959b0](https://github.com/unlimy-org/unlimy-cabinet/commit/97959b013241597e77ed3223fb5aa2d1de8be2d0))
* prevent countdown timer overflow on narrow mobile screens ([96bcc76](https://github.com/unlimy-org/unlimy-cabinet/commit/96bcc76d695ee7e26ad2538e1733f439e6a2983b))
* prevent onBlur race cancelling unlink confirmation ([3418ba9](https://github.com/unlimy-org/unlimy-cabinet/commit/3418ba9b8da69ec8ea3822971729bd16fcfcd1ce))
* prevent polling race condition and add missing zh/fa translations ([e571667](https://github.com/unlimy-org/unlimy-cabinet/commit/e57166745c24875ffd50b78e31bbd1e20480720f))
* prune unused workflows and harden deploy secret validation ([7640410](https://github.com/unlimy-org/unlimy-cabinet/commit/7640410748f1b8bc842884e627a284b34b84b01e))
* RBAC frontend type mismatches and translations ([4c9c399](https://github.com/unlimy-org/unlimy-cabinet/commit/4c9c3992abe5ffbf98ad1e44e8e9d4b899af6594))
* RBAC policies page role handling and permission gates ([56188b1](https://github.com/unlimy-org/unlimy-cabinet/commit/56188b1f8aa8526419d7a8e30389ef41787e7640))
* recursive setTimeout, Strict Mode guard, isAxiosError ([b350003](https://github.com/unlimy-org/unlimy-cabinet/commit/b35000367bbfb0041d33b3852f1eddb083b2e9a3))
* redesign role revoke confirmation dialog ([f829076](https://github.com/unlimy-org/unlimy-cabinet/commit/f829076bc2ec1f3229aa59d209ffbe5d1b00319f))
* redesign top bar and filter panel for mobile ([ea143fd](https://github.com/unlimy-org/unlimy-cabinet/commit/ea143fdbc91243375f2abe2b2250d1666aede769))
* reduce campaigns fetch limit to 100 (backend max) ([be168a7](https://github.com/unlimy-org/unlimy-cabinet/commit/be168a75df500757e0e2f5fbad19c178e3e817db))
* referral network graph rendering and layout ([b787726](https://github.com/unlimy-org/unlimy-cabinet/commit/b787726d1bbfd0371ae5b1f470777439e0a8c95c))
* referral network rendering — portal fix and visual tuning ([2b43a30](https://github.com/unlimy-org/unlimy-cabinet/commit/2b43a30ccccbc75e43dcc0fe5483b20e3ec66e04))
* referral system — stop cabinet redirect to Telegram, fix deep link code handling ([3c034d2](https://github.com/unlimy-org/unlimy-cabinet/commit/3c034d2e70359357c6522ff9ba703a69f1a2f5d6))
* register DOMPurify hooks once, abort featured upload, fix double drop ([5c0eb12](https://github.com/unlimy-org/unlimy-cabinet/commit/5c0eb129f437fe84e900391b02f1d4ff7557d26d))
* remove [@floating-ui](https://github.com/floating-ui) from radix chunk to resolve circular dependency ([772d83d](https://github.com/unlimy-org/unlimy-cabinet/commit/772d83d1c97f2689376bcadbd7b3c37cf8cb797e))
* remove animated background from news section, fix mobile borders ([8d994f7](https://github.com/unlimy-org/unlimy-cabinet/commit/8d994f75d9c34443276cc4203fc01c0d3bedf40e))
* remove bg-dark-950 from gift pages to preserve animated background ([c8ec221](https://github.com/unlimy-org/unlimy-cabinet/commit/c8ec2211112656ffc3787e905d9d6b2774bc6866))
* remove campaignUser fill color — campaign membership shown via edges ([2229eee](https://github.com/unlimy-org/unlimy-cabinet/commit/2229eeecb089a869483f2dbeb30f8817f434930d))
* remove colored background from logo on login page ([6bf0af4](https://github.com/unlimy-org/unlimy-cabinet/commit/6bf0af4ff33adcd74d7ac291f4e6e4734e1e72f1))
* remove dark backdrop overlay from share modal ([b213535](https://github.com/unlimy-org/unlimy-cabinet/commit/b213535738d1261fbd7a68bb89ccaa21348615e7))
* remove dead store code and add search input maxLength ([0f756d6](https://github.com/unlimy-org/unlimy-cabinet/commit/0f756d633d8d64e11e5738c20bf9e4fdd631a667))
* remove devices stat block, stretch countdown to full width ([396f814](https://github.com/unlimy-org/unlimy-cabinet/commit/396f814cbdfae24bad3da8ad29d34ae9196593b9))
* remove double URL-decode in extractTelegramUserId ([e8acfee](https://github.com/unlimy-org/unlimy-cabinet/commit/e8acfee3e462ad127d42b382d7a9c56f7742bba9))
* remove duplicate min withdrawal amount on referral page ([98ab109](https://github.com/unlimy-org/unlimy-cabinet/commit/98ab1099b9f9b639221b431205bd7eb9e8432d34))
* remove duplicate news title and replace N icon with newspaper SVG ([de5414f](https://github.com/unlimy-org/unlimy-cabinet/commit/de5414f42ef13bc9d2dc9a8349243a2f1cb821e3))
* remove duplicate tariff info line, make tariff card clickable ([bef5102](https://github.com/unlimy-org/unlimy-cabinet/commit/bef5102a7182ce4eb33a8fd366e6247b3cba9905))
* remove gemini-effect and noise backgrounds, fix aurora animation ([79ff741](https://github.com/unlimy-org/unlimy-cabinet/commit/79ff7412cbc374b7ac085b6c8d3fd5f34de8ce37))
* remove noreferrer from payment links to preserve Referer header ([45203da](https://github.com/unlimy-org/unlimy-cabinet/commit/45203dac5914c2abd60371ab552d2838048b3ef1))
* remove redundant subtitle and register hint from login page ([d596b05](https://github.com/unlimy-org/unlimy-cabinet/commit/d596b05048b4b14fac68acd606842d717bbc9dd1))
* remove server/location count from tariff cards and confirmation ([0fac368](https://github.com/unlimy-org/unlimy-cabinet/commit/0fac3689e57eee63489a379a966e89825f1a5854))
* remove unused linkTelegramWidget i18n key from all locales ([9b4a851](https://github.com/unlimy-org/unlimy-cabinet/commit/9b4a8512c2e3cedf1f075aef62415fa5464b69e6))
* rename "Regular user" to "No subscription" in legend ([cc64f7b](https://github.com/unlimy-org/unlimy-cabinet/commit/cc64f7b8ea7a136df4ad7dcf5cf2b1631455b031))
* rename duplicate 'purchases' i18n key to 'purchaseCount' ([0ce74ea](https://github.com/unlimy-org/unlimy-cabinet/commit/0ce74ea5fb7efad60bb78b56a0bf6518fecb88d8))
* rename Серверы to Локации in subscription card ([19e62fc](https://github.com/unlimy-org/unlimy-cabinet/commit/19e62fccf1efbb0c17a160348c75f9e695691bf1))
* render animated background via portal at z-index:-1 to stop implicit compositing ([12c97a2](https://github.com/unlimy-org/unlimy-cabinet/commit/12c97a2c5ebf0d3dc776f581589a9d4280fbdc2e))
* render newlines in tariff description ([0b4e825](https://github.com/unlimy-org/unlimy-cabinet/commit/0b4e8253aa7a55b2cac7f6632912816b3234adc3))
* replace broken modal with inline confirmation for role revoke ([78e7099](https://github.com/unlimy-org/unlimy-cabinet/commit/78e70992f169861fa51150ad06f91f047f3d0708))
* replace deprecated Telegram Login Widget redirect with callback ([32091d3](https://github.com/unlimy-org/unlimy-cabinet/commit/32091d3648889795d01d78bff933da3a38caa10f))
* replace framer-motion with CSS keyframes in boxes background ([7f17d95](https://github.com/unlimy-org/unlimy-cabinet/commit/7f17d95ed6f21b07fee5bd2201e1754611028209))
* replace hardcoded green with theme-aware accent color ([a3ddddf](https://github.com/unlimy-org/unlimy-cabinet/commit/a3ddddfa8ce167c22177fde3b131083c710ea619))
* replace orphaned shareModal i18n keys in GiftResult ([0322974](https://github.com/unlimy-org/unlimy-cabinet/commit/0322974ebdf0d904a5f39809c0e0da5dbdfe03b7))
* replace window.confirm with inline confirmation for unlink ([d0c01a0](https://github.com/unlimy-org/unlimy-cabinet/commit/d0c01a0e5cb656661b75175416ccf98c5aff8911))
* resolve all 14 ESLint warnings across the codebase ([885524a](https://github.com/unlimy-org/unlimy-cabinet/commit/885524a00f7ea022ba6bb01108557e2e4db1f952))
* resolve all 14 ESLint warnings across the codebase ([62188b8](https://github.com/unlimy-org/unlimy-cabinet/commit/62188b8d2e3cb090d0b27afe5cf4fcc65b3c68c2))
* resolve hover flickering caused by GPU layer destruction ([d8cf430](https://github.com/unlimy-org/unlimy-cabinet/commit/d8cf4301caeeccb890636faded3867bf22afef00))
* resolve Sigma container height error on page load ([3434073](https://github.com/unlimy-org/unlimy-cabinet/commit/3434073d7c327299db8ca80440d6054cf9e8065e))
* resolve telegram auth token expiration and clean up codebase ([c0b834a](https://github.com/unlimy-org/unlimy-cabinet/commit/c0b834ab0610c3dc23e27099f224177187181c8a))
* resolve telegram auth token expiration and clean up codebase ([2dab25c](https://github.com/unlimy-org/unlimy-cabinet/commit/2dab25c5a036fb90f75c80e4e28f2a53885f9038))
* restore package-lock.json for CI (npm ci requires it) ([069090a](https://github.com/unlimy-org/unlimy-cabinet/commit/069090a63412fdb99debe6e6058218b1e4105953))
* restore session from refresh token when access token is missing ([dc740ae](https://github.com/unlimy-org/unlimy-cabinet/commit/dc740ae2664059011fd755ccfa96ee46a26196d3))
* review findings — polling fallback, sessionStorage cleanup, UX ([da1926f](https://github.com/unlimy-org/unlimy-cabinet/commit/da1926f0e1ab7f117aef120ac7648bdd50add72c))
* review fixes - Math.round kopecks, fa locale, admin list commission ([82987fd](https://github.com/unlimy-org/unlimy-cabinet/commit/82987fd49a861a4ad167c10f89d51e88e8ecee51))
* rewrite 5 broken background components from Aceternity sources ([de97a03](https://github.com/unlimy-org/unlimy-cabinet/commit/de97a030d2ebffcfe957e179f32b2857d13465dc))
* rewrite BackgroundBoxes from 225 DOM divs to single canvas element ([d89c534](https://github.com/unlimy-org/unlimy-cabinet/commit/d89c534c0b21bff91747002a6e96bf12d114fcc2))
* rewrite gradient border with [@property](https://github.com/property) CSS angle animation ([d8b83cc](https://github.com/unlimy-org/unlimy-cabinet/commit/d8b83ccdb8d64e73e9f73785e4d81c5931aa28ec))
* rewrite HoverBorderGradient with CSS rotate instead of framer-motion ([e95db23](https://github.com/unlimy-org/unlimy-cabinet/commit/e95db23573987dcf1abff63a9fae0b3db3686764))
* route PendingGiftCard to gift activation tab instead of landing endpoint ([8ab740f](https://github.com/unlimy-org/unlimy-cabinet/commit/8ab740f8cb6ed9654b5f2d7d99d7f37a31e7de90))
* safe error handling and numeric client_id in OIDC login ([45e68ff](https://github.com/unlimy-org/unlimy-cabinet/commit/45e68ffac231516577ac1f5230bf90fd5a1b5cdb))
* scope selector UX, ARIA, and code quality improvements ([2780898](https://github.com/unlimy-org/unlimy-cabinet/commit/2780898d1c4944d69045a3271c1bbd67ef72c47a))
* second round review fixes for merge UI ([aa26059](https://github.com/unlimy-org/unlimy-cabinet/commit/aa26059e004dc7ce96b3b0953343ace5e86696c3))
* send Bearer token on email register (link to Telegram account) ([68e6ce1](https://github.com/unlimy-org/unlimy-cabinet/commit/68e6ce1bce1edc3c6048c1ed873865a27c39ea52))
* show actual connected devices count instead of device limit ([a819f30](https://github.com/unlimy-org/unlimy-cabinet/commit/a819f309c8105561618690e1408a826b3bce294a))
* show all campaigns in assign list, add dual links and bonus details ([a72042d](https://github.com/unlimy-org/unlimy-cabinet/commit/a72042d8075000db204b0f57c893928cadc68cef))
* show error state instead of blank page on purchase-options failure ([9d519fb](https://github.com/unlimy-org/unlimy-cabinet/commit/9d519fb5ec8c06c35f0967a0901940d934e1c882))
* show fallback when tariff has no available periods for renewal ([ea06ad1](https://github.com/unlimy-org/unlimy-cabinet/commit/ea06ad1d8f7894f5460d150fa72d094617b9fbbe))
* show infinity symbol for unlimited traffic on landing page ([bda95ed](https://github.com/unlimy-org/unlimy-cabinet/commit/bda95ed23f3b445c9a4a295a3be65310dae039e0))
* show locations count instead of servers on tariff cards ([ecc089d](https://github.com/unlimy-org/unlimy-cabinet/commit/ecc089da641c3b40739fbc4e77a997c27529b582))
* show nav labels from 2xl (1536px) instead of xl (1280px) ([3bae6cf](https://github.com/unlimy-org/unlimy-cabinet/commit/3bae6cf1e1e40c8f1434d64cdc4e99079856bc56))
* show progress bar instead of dots when device_limit &gt; 10 ([d567817](https://github.com/unlimy-org/unlimy-cabinet/commit/d567817e0564f2438d4192eb7b2321e1725da266))
* show total purchase count instead of paid on admin landings ([b9f1f59](https://github.com/unlimy-org/unlimy-cabinet/commit/b9f1f59e3cbcd5c9839a4a2e9eebeefa01364898))
* stack promo offer discounts with promo group discounts ([321bedc](https://github.com/unlimy-org/unlimy-cabinet/commit/321bedcb61a231d3dd8ecba8623d1ee9d632b9b7))
* stop beams background from causing UI flickering in browser ([7e89cce](https://github.com/unlimy-org/unlimy-cabinet/commit/7e89ccea5c8fceaedee2a550d1ba01d9074ac1b2))
* stop WS reconnect loop on auth rejection (code 1008) ([2efce0e](https://github.com/unlimy-org/unlimy-cabinet/commit/2efce0eb03c9511e7cd0aa814c364f6216e89e28))
* subscription UI improvements - expired card, duplicate badges, live countdown ([f4d7a2c](https://github.com/unlimy-org/unlimy-cabinet/commit/f4d7a2cc8d20301108d86654ff03250206536cf3))
* superadmin assignments show ENV badge, block UI revoke ([8e59af9](https://github.com/unlimy-org/unlimy-cabinet/commit/8e59af96c57ec69b9fd2e64a703699f04348d900))
* support method query param fallback for external browser redirects ([7ce5341](https://github.com/unlimy-org/unlimy-cabinet/commit/7ce5341e955ba34e7336959b09a528269e6b3417))
* support OIDC mode in TelegramLinkWidget for account linking ([880b2d4](https://github.com/unlimy-org/unlimy-cabinet/commit/880b2d45fe8966f510f77b83d6513e8be0ec1e47))
* support VK ID OAuth 2.1 device_id in frontend ([60f16e6](https://github.com/unlimy-org/unlimy-cabinet/commit/60f16e64e8cec2f540b2c49764fe711ddc9da86d))
* tag color bug, FormData interceptor, falsy id check ([13d27a5](https://github.com/unlimy-org/unlimy-cabinet/commit/13d27a5929fd688a3a38abc587f3ce15683c7f86))
* tile noise texture instead of stretching on large screens ([f652936](https://github.com/unlimy-org/unlimy-cabinet/commit/f652936d7867fba72b476de169de5e4b25bfaca5))
* unify device manager into additional options card with unbounded dot selector ([6dc8ca0](https://github.com/unlimy-org/unlimy-cabinet/commit/6dc8ca0d18bd0e23d6fa05b169f40686f6b2584c))
* use correct translation key for inactive campaign badge ([8207368](https://github.com/unlimy-org/unlimy-cabinet/commit/8207368ef77a772fdcf70d7ec798ddbbbfd9e63c))
* use dark label color on hover (white bg), light on normal (dark bg) ([ebe2c3a](https://github.com/unlimy-org/unlimy-cabinet/commit/ebe2c3af7e1b0abd622f4c8f20a94af5ca8e6076))
* use light label color for graph nodes on dark background ([0cc1cd5](https://github.com/unlimy-org/unlimy-cabinet/commit/0cc1cd5871a4b82ff2e9f1b8dc793d8563016362))
* use live panel traffic data in admin subscription card ([ac1550c](https://github.com/unlimy-org/unlimy-cabinet/commit/ac1550ce107fc37b81cdf0271666976499fed4ef))
* use openTelegramLink for CryptoBot payment to open invoice in Telegram ([fc0dd39](https://github.com/unlimy-org/unlimy-cabinet/commit/fc0dd3955092235c5b52c4da066954b6e3beaa19))
* use platform-conditional replace for QR navigation to preserve Telegram back behavior ([7bb75aa](https://github.com/unlimy-org/unlimy-cabinet/commit/7bb75aa92045d911533506cf922cbc8a45ef0968))
* use short 12-char code in bot and cabinet share links ([73d67bc](https://github.com/unlimy-org/unlimy-cabinet/commit/73d67bceedb84248992848c04d2792ae13c225a6))
* use white campaign edges to avoid blending with trial expired nodes ([2436060](https://github.com/unlimy-org/unlimy-cabinet/commit/2436060b5a79e6b3f485b177e1be87a8c02d307b))
* video not rendering — add TipTap Video extension, allow HTTP src ([25f3602](https://github.com/unlimy-org/unlimy-cabinet/commit/25f3602aeab451f3463a872256706dd91f35db5b))
* wheel lands on correct prize sector for Stars payment spins ([22bda66](https://github.com/unlimy-org/unlimy-cabinet/commit/22bda66e81714a2ff3e8de02b216af70509ced3e))
* админ-редактор — системные методы оплаты, реальные периоды тарифов, фильтрация на публичной странице ([e01c9f5](https://github.com/unlimy-org/unlimy-cabinet/commit/e01c9f51439fe74bbf74d7d40a7f7027252dbd17))
* безопасность и UX лендингов — 16 исправлений ([3cea482](https://github.com/unlimy-org/unlimy-cabinet/commit/3cea48235f373412071afbb7d811a2306ad15b78))
* блокировка кнопки устройств на странице подписки ([2d89b5e](https://github.com/unlimy-org/unlimy-cabinet/commit/2d89b5e342b7dbd3f6ae6457a7aba06db962c91c))
* добавлена подпись «Стоимость вращения» к блоку оплаты спина ([914a802](https://github.com/unlimy-org/unlimy-cabinet/commit/914a802c1bf770be375eeb460ab255681eaf76c0))
* заменить Tailwind green/emerald классы на success из темы ([86f75f2](https://github.com/unlimy-org/unlimy-cabinet/commit/86f75f25a78cd4b14c544ccb385474390d12d993))
* заменить хардкодный зелёный ([#3](https://github.com/unlimy-org/unlimy-cabinet/issues/3)EDBB0) на акцентный цвет из темы ([d526d09](https://github.com/unlimy-org/unlimy-cabinet/commit/d526d095dec1c4dc80f45ccd7940516a49051f3b))
* поддержка режима «both» — показ кнопки контакта вместе с тикетами ([f960d5f](https://github.com/unlimy-org/unlimy-cabinet/commit/f960d5fc0bc627f523d06d442f0f6efb6adc2d5a))
* скрыть плашку верификации email при выключенной верификации ([11e8191](https://github.com/unlimy-org/unlimy-cabinet/commit/11e81917af4b950d3b33dd9362424a295c9c2cbd))


### Performance Improvements

* add Zustand selectors to prevent cascading re-renders ([03ad255](https://github.com/unlimy-org/unlimy-cabinet/commit/03ad255bf1cf8d3d80552351e26c4b1dc11fb9b9))
* eagerly load Dashboard to improve LCP on main route ([5c1be14](https://github.com/unlimy-org/unlimy-cabinet/commit/5c1be1471e8b372bd6aec5470b0fdadf037cffbb))
* extract locales into separate chunk ([2c126f5](https://github.com/unlimy-org/unlimy-cabinet/commit/2c126f5e12d51beff6e21280b423b1851f93a0ac))
* extract Twemoji options to module-level const ([17b2f2e](https://github.com/unlimy-org/unlimy-cabinet/commit/17b2f2e90328b9388175d1047fa01bf6257d584c))
* fix critical WebGL GPU resource leaks in Aurora ([9a84e13](https://github.com/unlimy-org/unlimy-cabinet/commit/9a84e13e6cd4dcc3a6d5e7f95fddb4c9c1ec076e))
* fix GPU-heavy CSS patterns ([8604930](https://github.com/unlimy-org/unlimy-cabinet/commit/860493058a7d583edaea0e5261db1e485a016fc8))
* fix render cycle in useBranding and conditional polling ([30ece69](https://github.com/unlimy-org/unlimy-cabinet/commit/30ece694d43bd74fd2c26126926ec6452077681f))
* improve LCP — move font loading to HTML, defer logo preload ([962dd43](https://github.com/unlimy-org/unlimy-cabinet/commit/962dd43756438779b6cc1821f3ee6b8147113646))
* lazy-load locale files per language instead of bundling all ([9ae9ccc](https://github.com/unlimy-org/unlimy-cabinet/commit/9ae9cccbd96408c05f70163b50a63d7a33061a75))
* optimize animated backgrounds for mobile — reduce GPU load and memory pressure ([a933f66](https://github.com/unlimy-org/unlimy-cabinet/commit/a933f661e49b70af3fadee90bc93257f689086be))
* prefetch background chunk on page load from localStorage cache ([44d88f7](https://github.com/unlimy-org/unlimy-cabinet/commit/44d88f76532e5b9f7364210fafd3fc6c376c03cc))
* remove permanent GPU layer promotion from cards to fix flickering ([fe32322](https://github.com/unlimy-org/unlimy-cabinet/commit/fe32322c323cce342a343c21acde9422855a9295))
* throttle theme color picker, rewrite beams with CSS animation ([d019953](https://github.com/unlimy-org/unlimy-cabinet/commit/d0199536939a4553d5dace69453d52b37b6b50b0))


### Reverts

* remove device manager redesign, restore original device UI ([71a0111](https://github.com/unlimy-org/unlimy-cabinet/commit/71a0111a04d51f25ab8f4b226018519aeb3abcdc))
* remove user-facing reset traffic toggle ([4a68347](https://github.com/unlimy-org/unlimy-cabinet/commit/4a68347ae8aec6296187da084031c02474fb97a1))
